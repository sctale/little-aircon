      ...
      <div class="modes ${i?"heading":""}">
        ...
        ${Xt.map(t=>{const i=this._timerValue===t.value,o=e&&"timer_off"!==t.value;return V`
            <div
              ...
              @click=${()=>{o||this._setTimer(t.value)}}
            >
              ${n?V`<ha-icon class="mode-icon" .icon=${t.icon}></ha-icon>`:W}
              ${s?V`<span class="mode-name">${t.label}</span>`:W}
            </div>
          `})}
