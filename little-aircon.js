...
`;function pt(t,e,i,s={}){s=s||{},i=null==i?{}:i;const n=new CustomEvent(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed,detail:i});return t.dispatchEvent(n),n}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var s=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css","top"===i&&s.firstChild?s.insertBefore(n,s.firstChild):s.appendChild(n),n.styleSheet?n.styleSheet.cssText=t:n.appendChild(document.createTextNode(t))}}(ut);const ft=[0,1],gt=[.5,1],mt=["column","row"],vt=["climate"];class yt extends at{static getStubConfig(){return{header:{},layout:{mode:{}}}}setConfig(t){this._config=t}_openLink(){window.open("https://github.com/sctale/little-aircon/blob/master/README.md")}render(){if(!this.hass||!this._config)return V;const t=this._config;return B`
        ...
        <div class="overall-config">
          ...
          <div class="side-by-side">
            <ha-select
              ...
              @selected=${t=>this._configChanged("decimals",Number(t.detail.value))}
              @closed=${t=>t.stopPropagation()}
              fixedMenuPosition
            >
              ${ft.map(t=>B`<ha-list-item .value=${String(t)}>${t}</ha-list-item>`)}
            </ha-select>
          ...
          <div class="side-by-side">
            <ha-select
              label="布局方向（可选）"
              .value=${t.layout?.step??""}
              @selected=${t=>this._configChanged("layout.step",t.detail.value)}
              @closed=${t=>t.stopPropagation()}
              fixedMenuPosition
            >
              ${mt.map(t=>B`<ha-list-item .value=${t}>${"column"===t?"上下":"左右"}</ha-list-item>`)}
            </ha-select>

            <ha-select
              label="步进值（可选）"
              .value=${null!=t.step_size?String(t.step_size):""}
              @selected=${t=>this._configChanged("step_size",Number(t.detail.value))}
              @closed=${t=>t.stopPropagation()}
              fixedMenuPosition
            >
              ${gt.map(t=>B`<ha-list-item .value=${String(t)}>${t}</ha-list-item>`)}
            </ha-select>
          </div>
          ...
          <div class="side-by-side">
            <ha-select
              ...
              @selected=${t=>this._configChanged("layout.mode.names","hide"!==t.detail.value)}
              @closed=${t=>t.stopPropagation()}
              fixedMenuPosition
            >
            ...
            <ha-select
              ...
              @selected=${t=>this._configChanged("layout.mode.icons","hide"!==t.detail.value)}
              @closed=${t=>t.stopPropagation()}
              fixedMenuPosition
            >
              <ha-list-item .value="show">显示</ha-list-item>
          ...
          <div class="side-by-side">
            <ha-select
              ...
              @selected=${t=>this._configChanged("layout.mode.headings","hide"!==t.detail.value)}
              @closed=${t=>t.stopPropagation()}
              fixedMenuPosition
            >
              <ha-list-item .value="show">显示</ha-list-item>
    ...
    `}_entityPicked(t){const e=t.detail?.value??t.target?.value;void 0!==e&&this._configChanged("entity",e)}_configChanged(t,e){if(!this._config||!this.hass)return;const i=(s=this._config,JSON.parse(JSON.stringify(s)));var s;""===e||null==e?"entity"!==t&&function(t,e){const i=e.split(".");let s=t;for(;i.length>1;){const t=i.shift();if(!s[t])return;s=s[t]}delete s[i[0]]}(i,t):function(t,e,i){const s=e.split(".");let n=t;for(;s.length>1;){const t=s.shift();n[t]||(n[t]={}),n=n[t]}n[s[0]]=i}(i,t,e),this._config=i,pt(this,"config-changed",{config:i})}}yt.styles=ut,e([dt({attribute:!1})],yt.prototype,"hass",void 0),e([function(t){return dt({...t,state:!0,attribute:!1})}()],yt.prototype,"_config",void 0);const _t=(t,e,i,s)=>{if("length"===i||"prototype"===i)return;if("arguments"===i||"caller"===i)return;const n=Object.getOwnPropertyDescriptor(t,i),r=Object.getOwnPropertyDescriptor(e,i);!$t(n,r)&&s||Object.defineProperty(t,i,r)},$t=function(t,e){return void 0===t||t.configurable||t.writable===e.writable&&t.enumerable===e.enumerable&&t.configurable===e.configurable&&(t.writable||t.value===e.value)},bt=(t,e)=>`/* Wrapped ${t}*/\n${e}`,wt=Object.getOwnPropertyDescriptor(Function.prototype,"toString"),xt=Object.getOwnPropertyDescriptor(Function.prototype.toString,"name");function At(t,e,{ignoreNonConfigurable:i=!1}={}){const{name:s}=t;for(const s of Reflect.ownKeys(e))_t(t,e,s,i);return((t,e)=>{const i=Object.getPrototypeOf(e);i!==Object.getPrototypeOf(t)&&Object.setPrototypeOf(t,i)})(t,e),((t,e,i)=>{const s=""===i?"":`with ${i.trim()}() `,n=bt.bind(null,s,e.toString());Object.defineProperty(n,"name",xt),Object.defineProperty(t,"toString",{...wt,value:n})})(t,e,s),t}const Et=(t,e={})=>{if("function"!=typeof t)throw new TypeError(`Expected the first argument to be a function, got \`${typeof t}\``);const{wait:i=0,maxWait:s=Number.POSITIVE_INFINITY,before:n=!1,after:r=!0}=e;if(!n&&!r)throw new Error("Both `before` and `after` are false, function wouldn't be called.");let o,a,l;const c=function(...e){const c=this,h=()=>{a=void 0,o&&(clearTimeout(o),o=void 0),r&&(l=t.apply(c,e))},d=n&&!o;return clearTimeout(o),o=setTimeout(()=>{o=void 0,a&&(clearTimeout(a),a=void 0),r&&(l=t.apply(c,e))},i),s>0&&s!==Number.POSITIVE_INFINITY&&!a&&(a=setTimeout(h,s)),d&&(l=t.apply(c,e)),l};return At(c,t),c.cancel=()=>{o&&(clearTimeout(o),o=void 0),a&&(clearTimeout(a),a=void 0)},c};function St(t,{decimals:e=1,fallback:i="N/A"}={}){return null===t||""===t||["boolean","undefined"].includes(typeof t)?i:Number(t).toFixed(e)}function Ot({header:t,toggleEntityChanged:e,entity:i,openEntityPopover:s}){if(!1===t)return V;const n=i.attributes.hvac_action||i.state;let r=t.icon;"object"==typeof t.icon&&(r=r?.[n]??!1);const o=t?.name??!1;return B`
    <header>
      <div
        style="display: flex;"
        class="clickable"
        @click=${()=>s()}
      >
        ${function(t){return t?B` <ha-icon class="header__icon" .icon=${t}></ha-icon> `:V}(r)} ${function(t){return t?B`<h2 class="header__title">${t}</h2>`:V}(o)}
      </div>
  ...
  `}"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self&&self;var Pt={exports:{}};!function(t){function e(t){var i,s,n=new Error(t);return i=n,s=e.prototype,Object.setPrototypeOf?Object.setPrototypeOf(i,s):i.__proto__=s,n}function i(t,i,s){var n=i.slice(0,s).split(/\n/),r=n.length,o=n[r-1].length+1;throw e(t+=" at line "+r+" col "+o+":\n\n  "+i.split(/\n/)[r-1]+"\n  "+Array(o).join(" ")+"^")}e.prototype=Object.create(Error.prototype,{name:{value:"Squirrelly Error",enumerable:!1}});var s=new Function("return this")().Promise,n=!1;try{n=new Function("return (async function(){}).constructor")()}catch(t){if(!(t instanceof SyntaxError))throw t}function r(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function o(t,e,i){for(var s in e)r(e,s)&&(null==e[s]||"object"!=typeof e[s]||"storage"!==s&&"prefixes"!==s||i?t[s]=e[s]:t[s]=o({},e[s]));return t}var a=/^async +/,l=/`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g,c=/'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g,h=/"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g,d=/[.*+\-?^${}()|[\]\\]/g;function u(t){return d.test(t)?t.replace(d,"\\$&"):t}function p(t,s){s.rmWhitespace&&(t=t.replace(/[\r\n]+/g,"\n").replace(/^\s+|\s+$/gm,"")),l.lastIndex=0,c.lastIndex=0,h.lastIndex=0;var n=s.prefixes,r=[n.h,n.b,n.i,n.r,n.c,n.e].reduce(function(t,e){return t&&e?t+"|"+u(e):e?u(e):t},""),o=new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?"+u(s.tags[1])+")","g"),d=new RegExp("([^]*?)"+u(s.tags[0])+"(-|_)?\\s*("+r+")?\\s*","g"),p=0,f=!1;function g(e,n){var r,u={f:[]},g=0,m="c";function v(e){var n=t.slice(p,e),r=n.trim();if("f"===m)"safe"===r?u.raw=!0:s.async&&a.test(r)?(r=r.replace(a,""),u.f.push([r,"",!0])):u.f.push([r,""]);else if("fp"===m)u.f[u.f.length-1][1]+=r;else if("err"===m){if(r){var o=n.search(/\S/);i("invalid syntax",t,p+o)}}else u[m]=r;p=e+1}for("h"===n||"b"===n||"c"===n?m="n":"r"===n&&(u.raw=!0,n="i"),o.lastIndex=p;null!==(r=o.exec(t));){var y=r[1],_=r[2],$=r[3],b=r[4],w=r[5],x=r.index;if(y)"("===y?(0===g&&("n"===m?(v(x),m="p"):"f"===m&&(v(x),m="fp")),g++):")"===y?0===--g&&"c"!==m&&(v(x),m="err"):0===g&&"|"===y?(v(x),m="f"):"=>"===y&&(v(x),p+=1,m="res");else if(_)if("/*"===_){var A=t.indexOf("*/",o.lastIndex);-1===A&&i("unclosed comment",t,r.index),o.lastIndex=A+2}else"'"===_?(c.lastIndex=r.index,c.exec(t)?o.lastIndex=c.lastIndex:i("unclosed string",t,r.index)):'"'===_?(h.lastIndex=r.index,h.exec(t)?o.lastIndex=h.lastIndex:i("unclosed string",t,r.index)):"`"===_&&(l.lastIndex=r.index,l.exec(t)?o.lastIndex=l.lastIndex:i("unclosed string",t,r.index));else if($)return v(x),p=x+r[0].length,d.lastIndex=p,f=w,b&&"h"===n&&(n="s"),u.t=n,u}return i("unclosed tag",t,e),u}var m=function r(o,l){o.b=[],o.d=[];var c,h=!1,u=[];function m(t,e){t&&(t=function(t,e,i,s){var n,r;return"string"==typeof e.autoTrim?n=r=e.autoTrim:Array.isArray(e.autoTrim)&&(n=e.autoTrim[1],r=e.autoTrim[0]),(i||!1===i)&&(n=i),(s||!1===s)&&(r=s),"slurp"===n&&"slurp"===r?t.trim():("_"===n||"slurp"===n?t=String.prototype.trimLeft?t.trimLeft():t.replace(/^[\s\uFEFF\xA0]+/,""):"-"!==n&&"nl"!==n||(t=t.replace(/^(?:\n|\r|\r\n)/,"")),"_"===r||"slurp"===r?t=String.prototype.trimRight?t.trimRight():t.replace(/[\s\uFEFF\xA0]+$/,""):"-"!==r&&"nl"!==r||(t=t.replace(/(?:\n|\r|\r\n)$/,"")),t)}(t,s,f,e))&&(t=t.replace(/\\|'/g,"\\$&").replace(/\r\n|\n|\r/g,"\\n"),u.push(t))}for(;null!==(c=d.exec(t));){var v,y=c[1],_=c[2],$=c[3]||"";for(var b in n)if(n[b]===$){v=b;break}m(y,_),p=c.index+c[0].length,v||i("unrecognized tag type: "+$,t,p);var w=g(c.index,v),x=w.t;if("h"===x){var A=w.n||"";s.async&&a.test(A)&&(w.a=!0,w.n=A.replace(a,"")),w=r(w),u.push(w)}else if("c"===x){if(o.n===w.n)return h?(h.d=u,o.b.push(h)):o.d=u,o;i("Helper start and end don't match",t,c.index+c[0].length)}else if("b"===x){h?(h.d=u,o.b.push(h)):o.d=u;var E=w.n||"";s.async&&a.test(E)&&(w.a=!0,w.n=E.replace(a,"")),h=w,u=[]}else if("s"===x){var S=w.n||"";s.async&&a.test(S)&&(w.a=!0,w.n=S.replace(a,"")),u.push(w)}else u.push(w)}if(!l)throw e('unclosed helper "'+o.n+'"');return m(t.slice(p,t.length),!1),o.d=u,o}({f:[]},!0);if(s.plugins)for(var v=0;v<s.plugins.length;v++){var y=s.plugins[v];y.processAST&&(m.d=y.processAST(m.d,s))}return m.d}function f(t,e){var i=p(t,e),s="var tR='';"+(e.useWith?"with("+e.varName+"||{}){":"")+_(i,e)+"if(cb){cb(null,tR)} return tR"+(e.useWith?"}":"");if(e.plugins)for(var n=0;n<e.plugins.length;n++){var r=e.plugins[n];r.processFnString&&(s=r.processFnString(s,e))}return s}function g(t,e){for(var i=0;i<e.length;i++){var s=e[i][0],n=e[i][1];t=(e[i][2]?"await ":"")+"c.l('F','"+s+"')("+t,n&&(t+=","+n),t+=")"}return t}function m(t,e,i,s,n,r){var o="{exec:"+(n?"async ":"")+y(i,e,t)+",params:["+s+"]";return r&&(o+=",name:'"+r+"'"),n&&(o+=",async:true"),o+"}"}function v(t,e){for(var i="[",s=0;s<t.length;s++){var n=t[s];i+=m(e,n.res||"",n.d,n.p||"",n.a,n.n),s<t.length&&(i+=",")}return i+"]"}function y(t,e,i){return"function("+e+"){var tR='';"+_(t,i)+"return tR}"}function _(t,e){for(var i=0,s=t.length,n="";i<s;i++){var r=t[i];if("string"==typeof r)n+="tR+='"+r+"';";else{var o=r.t,a=r.c||"",l=r.f,c=r.n||"",h=r.p||"",d=r.res||"",u=r.b,p=!!r.a;if("i"===o){e.defaultFilter&&(a="c.l('F','"+e.defaultFilter+"')("+a+")");var f=g(a,l);!r.raw&&e.autoEscape&&(f="c.l('F','e')("+f+")"),n+="tR+="+f+";"}else if("h"===o)if(e.storage.nativeHelpers.get(c))n+=e.storage.nativeHelpers.get(c)(r,e);else{var y=(p?"await ":"")+"c.l('H','"+c+"')("+m(e,d,r.d,h,p);y+=u?","+v(u,e):",[]",n+="tR+="+g(y+=",c)",l)+";"}else"s"===o?n+="tR+="+g((p?"await ":"")+"c.l('H','"+c+"')({params:["+h+"]},[],c)",l)+";":"e"===o&&(n+=a+"\n")}}return n}var $=function(){function t(t){this.cache=t}return t.prototype.define=function(t,e){this.cache[t]=e},t.prototype.get=function(t){return this.cache[t]},t.prototype.remove=function(t){delete this.cache[t]},t.prototype.reset=function(){this.cache={}},t.prototype.load=function(t){o(this.cache,t,!0)},t}();function b(t,i,s,n){if(i&&i.length>0)throw e((n?"Native":"")+"Helper '"+t+"' doesn't accept blocks");if(s&&s.length>0)throw e((n?"Native":"")+"Helper '"+t+"' doesn't accept filters")}var w={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function x(t){return w[t]}var A=new $({}),E=new $({each:function(t,e){var i="",s=t.params[0];if(b("each",e,!1),t.async)return new Promise(function(e){!function t(e,i,s,n,r){s(e[i],i).then(function(o){n+=o,i===e.length-1?r(n):t(e,i+1,s,n,r)})}(s,0,t.exec,i,e)});for(var n=0;n<s.length;n++)i+=t.exec(s[n],n);return i},foreach:function(t,e){var i=t.params[0];if(b("foreach",e,!1),t.async)return new Promise(function(e){!function t(e,i,s,n,r,o){n(i[s],e[i[s]]).then(function(a){r+=a,s===i.length-1?o(r):t(e,i,s+1,n,r,o)})}(i,Object.keys(i),0,t.exec,"",e)});var s="";for(var n in i)r(i,n)&&(s+=t.exec(n,i[n]));return s},include:function(t,i,s){b("include",i,!1);var n=s.storage.templates.get(t.params[0]);if(!n)throw e('Could not fetch template "'+t.params[0]+'"');return n(t.params[1],s)},extends:function(t,i,s){var n=t.params[1]||{};n.content=t.exec();for(var r=0;r<i.length;r++){var o=i[r];n[o.name]=o.exec()}var a=s.storage.templates.get(t.params[0]);if(!a)throw e('Could not fetch template "'+t.params[0]+'"');return a(n,s)},useScope:function(t,e){return b("useScope",e,!1),t.exec(t.params[0])}}),S=new $({if:function(t,e){b("if",!1,t.f,!0);var i="if("+t.p+"){"+_(t.d,e)+"}";if(t.b)for(var s=0;s<t.b.length;s++){var n=t.b[s];"else"===n.n?i+="else{"+_(n.d,e)+"}":"elif"===n.n&&(i+="else if("+n.p+"){"+_(n.d,e)+"}")}return i},try:function(t,i){if(b("try",!1,t.f,!0),!t.b||1!==t.b.length||"catch"!==t.b[0].n)throw e("native helper 'try' only accepts 1 block, 'catch'");var s="try{"+_(t.d,i)+"}",n=t.b[0];return s+"catch"+(n.res?"("+n.res+")":"")+"{"+_(n.d,i)+"}"},block:function(t,e){return b("block",t.b,t.f,!0),"if(!"+e.varName+"["+t.p+"]){tR+=("+y(t.d,"",e)+")()}else{tR+="+e.varName+"["+t.p+"]}"}}),O=new $({e:function(t){var e=String(t);return/[&<>"']/.test(e)?e.replace(/[&<>"']/g,x):e}}),P={varName:"it",autoTrim:[!1,"nl"],autoEscape:!0,defaultFilter:!1,tags:["{{","}}"],l:function(t,i){if("H"===t){var s=this.storage.helpers.get(i);if(s)return s;throw e("Can't find helper '"+i+"'")}if("F"===t){var n=this.storage.filters.get(i);if(n)return n;throw e("Can't find filter '"+i+"'")}},async:!1,storage:{helpers:E,nativeHelpers:S,filters:O,templates:A},prefixes:{h:"@",b:"#",i:"",r:"*",c:"/",e:"!"},cache:!1,plugins:[],useWith:!1};function C(t,e){var i={};return o(i,P),e&&o(i,e),t&&o(i,t),i.l.bind(i),i}function k(t,i){var s=C(i||{}),r=Function;if(s.async){if(!n)throw e("This environment doesn't support async/await");r=n}try{return new r(s.varName,"c","cb",f(t,s))}catch(i){throw i instanceof SyntaxError?e("Bad template syntax\n\n"+i.message+"\n"+Array(i.message.length+1).join("=")+"\n"+f(t,s)):i}}function T(t,e){var i;return e.cache&&e.name&&e.storage.templates.get(e.name)?e.storage.templates.get(e.name):(i="function"==typeof t?t:k(t,e),e.cache&&e.name&&e.storage.templates.define(e.name,i),i)}P.l.bind(P),t.compile=k,t.compileScope=_,t.compileScopeIntoFunction=y,t.compileToString=f,t.defaultConfig=P,t.filters=O,t.getConfig=C,t.helpers=E,t.nativeHelpers=S,t.parse=p,t.render=function(t,i,n,r){var o=C(n||{});if(!o.async)return T(t,o)(i,o);if(!r){if("function"==typeof s)return new s(function(e,s){try{e(T(t,o)(i,o))}catch(t){s(t)}});throw e("Please provide a callback function, this env doesn't support Promises")}try{T(t,o)(i,o,r)}catch(t){return r(t)}},t.templates=A,Object.defineProperty(t,"__esModule",{value:!0})}(Pt.exports);var Ct=Pt.exports;const kt=2;class Tt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class zt extends Tt{constructor(t){if(super(t),this.it=V,t.type!==kt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===V||null==t)return this._t=void 0,this.it=t;if(t===W)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}zt.directiveName="unsafeHTML",zt.resultType=1;const jt=(t=>(...e)=>({_$litDirective$:t,values:e}))(zt),Nt=t=>`<ha-icon icon="${t}"></ha-icon>`;function Rt(t,e){const{type:i,labels:s}=t?.layout?.sensors??{type:"table",labels:!0};return B` <div class="sensors ${[s?"with-labels":"without-labels","list"===i?"as-list":"as-table"].join(" ")}">${e}</div> `}function Ht({hide:t=!1,hass:e,state:i,details:s,localize:n,openEntityPopover:r}){if(t||void 0===i)return V;const{type:o,heading:a,icon:l,unit:c,decimals:h}=s;if("relativetime"===o)return B`
    ...
    `}let d="number"==typeof h?St(i,{decimals:h}):i;return B`<div class="sensor-value">${d}${c||""}</div>`}var Mt;Ct.defaultConfig.autoEscape=!1,Ct.filters.define("icon",Nt),Ct.filters.define("join",(t,e=", ")=>t.join(e)),Ct.filters.define("css",(t,e)=>`<span style="${Object.entries(e).reduce((t,[e,i])=>`${t}${e}:${i};`,"")}">${t}</span>`),Ct.filters.define("debug",t=>{try{return JSON.stringify(t)}catch{return`Not able to read valid JSON object from: ${t}`}}),function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(Mt||(Mt={}));const Ut={off:"关闭",heat:"制热",cool:"制冷",auto:"自动",dry:"除湿",fan_only:"送风",heat_cool:"冷热",none:"无",eco:"节能",away:"离家",boost:"增强",comfort:"舒适",home:"在家",sleep:"睡眠",activity:"活动",vertical:"上下摆风",horizontal:"左右摆风",both:"全方位摆风",on:"开启",low:"低速",medium:"中速",medium_low:"中低速",medium_high:"中高速",high:"高速",highest:"最高速",full:"满速",silent:"静音",auto_mode:"自动"};function It({state:t,mode:e,modeOptions:i,localize:s,setMode:n}){const{type:r,hide_when_off:o,mode:a="none",list:l,name:c}=e;if(0===l.length||o&&t===Mt.OFF)return V;const h=(()=>{if(c)return"string"==typeof c?c:"";return{hvac:"运行模式",preset:"预设模式",fan:"风速模式",swing:"摆风模式",swing_horizontal:"左右摆风"}[r]??`${r}_mode`})(),d=i?.headings??!0;return B`
          ...
          ${Object.entries(this._values).map(([t,s])=>{const a=["string","number"].includes(typeof s),l=!1!==n&&a;return B`
              <div class="current-wrapper ${r}">
                ...
                <ha-icon-button
                  ...
                  @click=${()=>this.setTemperature(this.stepSize,t)}
                >
                  <ha-icon .icon=${o?Gt:Jt}></ha-icon>
                </ha-icon-button>
              </div>
            `})}
        </section>

        ${this.modes.map(t=>It({state:this.entity.state,mode:t,localize:this.localize,modeOptions:this.config?.layout?.mode??{},setMode:this.setMode}))}
      </ha-card>
    `}setTemperature(t,e){this._updatingValues=!0;const i=this._values[e],s=Number(i)+t,{decimals:n}=this.config;this._values={...this._values,[e]:+St(s,{decimals:n})},this._debouncedSetTemperature(this._values)}getCardSize(){return 3}getUnit(){return["boolean","string"].includes(typeof this.config.unit)?this.config?.unit:this._hass.config?.unit_system?.temperature??!1}}ee.styles=ut,e([dt({type:Object})],ee.prototype,"config",void 0),e([dt({type:Object})],ee.prototype,"header",void 0),e([dt({type:Object})],ee.prototype,"service",void 0),e([dt({type:Array})],ee.prototype,"modes",void 0),e([dt({type:Object})],ee.prototype,"entity",void 0),e([dt({type:Array})],ee.prototype,"sensors",void 0),e([dt({type:Boolean})],ee.prototype,"showSensors",void 0),e([dt({type:String})],ee.prototype,"name",void 0),e([dt({type:Object})],ee.prototype,"_values",void 0),e([dt({type:Boolean})],ee.prototype,"_updatingValues",void 0),e([dt({type:Object})],ee.prototype,"_hide",void 0),customElements.define(t,ee),customElements.define(`${t}-editor`,yt),console.info(`%c${t}: 3.0.19`,"font-weight: bold"),window.customCards=window.customCards||[],window.customCards.push({type:t,name:"小空调",preview:!1,description:"Home Assistant 温控卡片（lit v3 / HASS 2026.x 兼容，中文界面）"});
