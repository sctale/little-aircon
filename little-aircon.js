...
`;function pt(t,e,i,s={}){s=s||{},i=null==i?{}:i;const n=new CustomEvent(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed,detail:i});return t.dispatchEvent(n),n}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var s=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css","top"===i&&s.firstChild?s.insertBefore(n,s.firstChild):s.appendChild(n),n.styleSheet?n.styleSheet.cssText=t:n.appendChild(document.createTextNode(t))}}(ut);const ft=["climate"],mt=["sensor"],gt=[{value:"0",label:"0"},{value:"1",label:"1"}],vt=[{value:"0.5",label:"0.5"},{value:"1",label:"1"}],yt=[{value:"column",label:"上下"},{value:"row",label:"左右"}],_t=[{value:"show",label:"显示"},{value:"hide",label:"隐藏"}];class $t extends at{static getStubConfig(){return{header:{},layout:{mode:{}}}}setConfig(t){this._config=t}_openLink(){window.open("https://github.com/sctale/little-aircon/blob/master/README.md")}render(){if(!this.hass||!this._config)return W;const t=this._config;let e;return e=Array.isArray(t.control)?t.control:"object"==typeof t.control&&null!==t.control?Object.keys(t.control):["hvac","preset"],V`
  ...
  `}({...t,variables:this.config.variables,hass:this._hass,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover})),l=Ht(this.config,l)):l=this.showSensors?function({_hide:t,entity:e,unit:i,hass:s,sensors:n,config:o,localize:r,openEntityPopover:a}){const{state:l,attributes:{hvac_action:c,current_temperature:h}}=e;let d=h;o?.sensor_entity&&s?.states[o.sensor_entity]&&(d=s.states[o.sensor_entity].state);const u=o?.layout?.sensors?.labels??!0;let p=(t=>({off:"关闭",heat:"制热",cool:"制冷",auto:"自动",dry:"除湿",fan_only:"送风",heat_cool:"冷热",idle:"待机",heating:"制热",cooling:"制冷",drying:"除湿",fan:"送风"}[t]??t))(l);c&&c!==l&&(p=`${p} (${(t=>({idle:"待机",heating:"正在制热",cooling:"正在制冷",drying:"正在除湿",fan:"正在送风",off:"已关闭"}[t]??t))(c)})`);const f=[Mt({hide:t.temperature,state:`${Pt(d,o)}${i||""}`,hass:s,details:{heading:!!u&&(o?.label?.temperature??"当前温度")}}),Mt({hide:t.state,state:p,hass:s,details:{heading:!!u&&(o?.label?.state??"运行状态")}}),...n.map(({name:t,state:e,...i})=>Mt({state:e,hass:s,localize:r,openEntityPopover:a,details:{...i,heading:u&&t}}))||null].filter(t=>null!==t);return V`${Ht(o,f)}`}({_hide:this._hide,unit:n,hass:this._hass,entity:this.entity,sensors:this.sensors,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}):"",V`
    ...
    `}_renderTimer(){const t=this.config?.timer;if(!t||"hide"===t)return W;const e="off"===this.entity?.state,i=this.config?.layout?.mode?.headings??!0;return V`
      <div class="modes ${i?"heading":""}">
        ${i?V`<div class="mode-title">定时关机</div>`:W}
        ${Xt.map(t=>{const i=this._timerValue===t.value;return V`
            <div
              class="mode-item ${i?"active "+t.value:""} ${e&&"timer_off"!==t.value?"disabled":""}"
              @click=${()=>!e&&this._setTimer(t.value)}
            >
              <ha-icon class="mode-icon" .icon=${t.icon}></ha-icon>
              ${this.config,W}
              ${!1===this.config?.layout?.mode?.names?W:V`${t.label}`}
            </div>
          `})}
